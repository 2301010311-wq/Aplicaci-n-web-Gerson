  ...
  const menuItems = [
    {
      ...
      href: "/dashboard",
      roles: ["Admin", "Mesero", "Cocinero", "Cajero", "Tester"],
    },
    {
      title: "Usuarios",
      icon: Users,
    ...
    },
    {
      ...
      icon: ShoppingCart,
      href: "/pedidos",
      roles: ["Admin", "Mesero", "Cajero", "Tester"],
    },
    {
      title: "Cocina",
      icon: ChefHat,
      href: "/cocina",
      roles: ["Admin", "Cocinero", "Tester"],
    },
    {
      title: "Pagos",
      icon: DollarSign,
      href: "/pagos",
      roles: ["Admin", "Cajero", "Tester"],
    },
    {
      title: "Registros",
      icon: BarChart3,
